class ReplicatedClassMap<Class TKey, Class TValue>
{
	...
	static bool PropCompare(ReplicatedClassMap<TKey, ref TValue> rplMap, SSnapSerializerBase snapshot, ScriptCtx ctx)
	{
		int snapCount;
	...
	static bool Extract(ReplicatedClassMap<TKey, ref TValue> rplMap, ScriptCtx ctx, SSnapSerializerBase snapshot)
	{
	...
	static bool Inject(SSnapSerializerBase snapshot, ScriptCtx ctx, ReplicatedClassMap<TKey, ref TValue> rplMap)
	{
		rplMap.Clear();
		int count;
		snapshot.SerializeInt(count);
